...
<script>
	$(document).ready(function(){
		...
		$("#productName").change(function money(){
			...
			$("#money").val(temp[$("#productName").val()].productBuyPrice*$("#number").val())
		})
...
<form class="form-horizontal" role="form" action="buy.do" method="post">
									${requestScope.msg }
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="oldPassword" >请选择要购买的产品</label>
